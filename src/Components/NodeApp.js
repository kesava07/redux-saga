...
export default class NodeApp extends Component {
    ...
    getData = () => {
        ...
        Axios.get("https://sample-auth-7c2db.firebaseio.com/curdOperations.json")
            .then(res => {
                const fetchedData = []
    ...
    handlePostData = () => {
        ...
        if (this.state.inputText) {
            ...
            Axios.post("https://sample-auth-7c2db.firebaseio.com/curdOperations.json", data)
                .then(res => {
    ...
    handleDelete = data => {
        Axios.delete(`https://sample-auth-7c2db.firebaseio.com/curdOperations/${data.id}.json`)
